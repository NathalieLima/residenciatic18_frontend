...
var fetchPromise = fetch("https://mdn.github.io/learning-area/javascript/apis/fetching-data/can-store/products.json");
console.log(fetchPromise);
fetchPromise.then(function (resposta) {
    console.log("Resposta recebida: ".concat(resposta.status));
});
